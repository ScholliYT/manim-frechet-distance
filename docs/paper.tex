...
For each curve, a point with the maximum shortest distance to a point on the other curve is searched for, see \autoref{fig_hausdorff_distance_example}.
The Hausdorff distance is mathematically formulated as stated in \autoref{eq_hausdorff_distance} \cite{alt_computing_1995}.
