...
\begin{figure}[ht]
  \centering
  % TODO: Replace graphic with appropiate example
  \includegraphics[width=\textwidth]{images/hausdorff/hausdorff-distance-example.pdf}
...
and can be used as an approximation. % Source?
\cite{eiter_computing_nodate}
...
Computing the complete free space is very compute intensive 
...
we can make another observation requiring only a few points to be computed per cell. 
...
\begin{figure}[ht]
  ...
  % TODO: Replace graphic with appropiate example
  \includegraphics[width=\textwidth]{images/hausdorff/hausdorff-distance-example.pdf}
  \caption[Legal intervals on free space cell boundary]{Legal intervals on the boundaries of a free space cell.}
